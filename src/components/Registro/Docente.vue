        ...
        <form @submit.prevent="submitDocente" class="form">
          ...
          <div class="form-row">
            <div class="form-group full-width">
              ...
              <input v-model="docente.apellidoPaterno" type="text" id="apellidoPaterno" class="form-input" placeholder="Apellido Paterno" required />
            </div>
          </div>
          ...
          <div class="form-row">
            <div class="form-group full-width">
              ...
              <input v-model="docente.apellidoMaterno" type="text" id="apellidoMaterno" class="form-input" placeholder="Apellido Materno" />
            </div>
          </div>
